"""
Pipeline: wanita-baju
Extracts neck + collar/clothing region.
Focus: from chin down to chest area, showing neck and clothing neckline.
"""
...
class BajuPipeline(BasePipeline):
    def crop_part(self, image, landmarks):
        ...
        # ─── Vertical ─────────────────────────────────
        # Top: from chin area (lower = more clothing visible)
